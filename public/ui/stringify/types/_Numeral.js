define(function (require) {
  return function AbstractNumeralFormatProvider(Private) {
    ...
    require('plugins/customTileMap/ui/field_format_editor/numeral/numeral');
    ...
    Numeral.factory = function (opts) {
      ...
      Class.editor = {
        template: opts.editorTemplate || require('plugins/customTileMap/ui/field_format_editor/numeral/numeral.html'),
        controllerAs: 'cntrl',
