define(function (require) {
  return function _StringProvider(Private) {
    require('plugins/customTileMap/ui/stringify/editors/color.less');

    const _ = require('lodash');
    const FieldFormat = Private(require('plugins/customTileMap/ui/index_patterns/_field_format/FieldFormat'));
    const DEFAULT_COLOR = {
    ...
    _Color.editor = {
      template: require('plugins/customTileMap/ui/stringify/editors/color.html'),
      controller($scope) {
