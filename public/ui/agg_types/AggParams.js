define(function (require) {
  return function AggParamsFactory(Private) {
    require('plugins/customTileMap/ui/filters/label');

    let _ = require('lodash');
    let IndexedArray = require('plugins/customTileMap/ui/IndexedArray');

    let paramTypeMap = {
      field: Private(require('plugins/customTileMap/ui/agg_types/param_types/field')),
      optioned: Private(require('plugins/customTileMap/ui/agg_types/param_types/optioned')),
      regex: Private(require('plugins/customTileMap/ui/agg_types/param_types/regex')),
      string: Private(require('plugins/customTileMap/ui/agg_types/param_types/string')),
      json: Private(require('plugins/customTileMap/ui/agg_types/param_types/raw_json')),
      _default: Private(require('plugins/customTileMap/ui/agg_types/param_types/base'))
    };
