describe('AggParams class', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    AggParams = Private(require('plugins/customTileMap/ui/agg_types/AggParams'));
    BaseAggParam = Private(require('plugins/customTileMap/ui/agg_types/param_types/base'));
    FieldAggParam = Private(require('plugins/customTileMap/ui/agg_types/param_types/field'));
    OptionedAggParam = Private(require('plugins/customTileMap/ui/agg_types/param_types/optioned'));
