describe('bucketCountBetween util', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    ...
    visTypes = Private(require('plugins/customTileMap/ui/registry/vis_types'));
    aggTypes = Private(require('plugins/customTileMap/ui/agg_types/index'));
    AggConfig = Private(require('plugins/customTileMap/ui/Vis/AggConfig'));
    bucketCountBetween = Private(require('plugins/customTileMap/ui/agg_types/buckets/_bucket_count_between'));
  }));
