describe('Range Agg', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    range = Private(require('plugins/customTileMap/ui/agg_types/index')).byName.range;
    Vis = Private(require('plugins/customTileMap/ui/Vis'));
    indexPattern = Private(require('fixtures/stubbed_logstash_index_pattern'));

    let BytesFormat = Private(require('plugins/customTileMap/ui/registry/field_formats')).byId.bytes;
