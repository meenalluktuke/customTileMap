...
module.exports = function stubParamClasses(Private) {
  let BaseAggParam = Private.stub(
    require('plugins/customTileMap/ui/agg_types/param_types/base'),
  ...
  Private.stub(
    require('plugins/customTileMap/ui/agg_types/param_types/field'),
    new ParamClassStub(BaseAggParam)
  );

  Private.stub(
    require('plugins/customTileMap/ui/agg_types/param_types/optioned'),
    new ParamClassStub(BaseAggParam)
  );
};
