define(function (require) {
  return function FieldAggParamFactory(Private) {
    ...
    let editorHtml = require('plugins/customTileMap/ui/agg_types/controls/field.html');
    let BaseAggParam = Private(require('plugins/customTileMap/ui/agg_types/param_types/base'));
    let SavedObjectNotFound = require('plugins/customTileMap/ui/errors').SavedObjectNotFound;
