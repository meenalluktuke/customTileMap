define(function (require) {
  return function AggTypeMetricPercentilesProvider(Private) {
    ...
    let getResponseAggConfigClass = Private(require('plugins/customTileMap/ui/agg_types/metrics/getResponseAggConfigClass'));
    let ordinalSuffix = require('plugins/customTileMap/ui/utils/ordinal_suffix');
    let fieldFormats = Private(require('plugins/customTileMap/ui/registry/field_formats'));

    let percentsEditor = require('plugins/customTileMap/ui/agg_types/controls/percentiles.html');
    // required by the percentiles editor
    require('plugins/customTileMap/ui/number_list');
