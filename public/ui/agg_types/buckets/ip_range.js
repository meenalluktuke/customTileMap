define(function (require) {
  ...
  require('plugins/customTileMap/ui/directives/validate_ip');
  require('plugins/customTileMap/ui/directives/validate_cidr_mask');
  ...
  return function RangeAggDefinition(Private) {
    ...
    let createFilter = Private(require('plugins/customTileMap/ui/agg_types/buckets/create_filter/ip_range'));
      ...
      params: [
        {
          ...
          editor: require('plugins/customTileMap/ui/agg_types/controls/ip_ranges.html'),
