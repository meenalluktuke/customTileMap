define(function (require) {
  return function DateHistogramAggType(timefilter, config, Private) {
    ...
    let TimeBuckets = Private(require('plugins/customTileMap/ui/time_buckets'));
    let createFilter = Private(require('plugins/customTileMap/ui/agg_types/buckets/create_filter/date_histogram'));
    let intervalOptions = Private(require('plugins/customTileMap/ui/agg_types/buckets/_interval_options'));
    let configDefaults = Private(require('plugins/customTileMap/ui/config/defaults'));
    ...
    require('plugins/customTileMap/ui/filters/field_type');
