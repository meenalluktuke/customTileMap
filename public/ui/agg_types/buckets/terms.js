define(function (require) {
  return function TermsAggDefinition(Private) {
    ...
    let bucketCountBetween = Private(require('plugins/customTileMap/ui/agg_types/buckets/_bucket_count_between'));
    let AggConfig = Private(require('plugins/customTileMap/ui/Vis/AggConfig'));
    let Schemas = Private(require('plugins/customTileMap/ui/Vis/Schemas'));
    let createFilter = Private(require('plugins/customTileMap/ui/agg_types/buckets/create_filter/terms'));
    ...
    return new BucketAggType({
      ...
      params: [
        ...
        },
        {
          ...
          type: AggConfig,
          default: null,
          editor: require('plugins/customTileMap/ui/agg_types/controls/order_agg.html'),
        ...
        },
        {
          ...
          type: 'optioned',
          default: 'desc',
          editor: require('plugins/customTileMap/ui/agg_types/controls/order_and_size.html'),
          options: [
