define(function (require) {
  return function FiltersAggDefinition(Private, Notifier) {
    ...
    let createFilter = Private(require('plugins/customTileMap/ui/agg_types/buckets/create_filter/filters'));
    ...
    return new BucketAggType({
      ...
      params: [
        {
          name: 'filters',
          editor: require('plugins/customTileMap/ui/agg_types/controls/filters.html'),
          default: [ {input: {}, label: ''} ],
