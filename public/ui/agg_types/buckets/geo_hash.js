define(function (require) {
  return function GeoHashAggDefinition(Private, config) {
    ...
    function getPrecision(precision) {
      let maxPrecision = _.parseInt(config.get('visualization:customTileMap:maxPrecision'));
    ...
    return new BucketAggType({
      ...
      params: [
        ...
        },
        {
          ...
          editor: require('plugins/customTileMap/ui/agg_types/controls/precision.html'),
