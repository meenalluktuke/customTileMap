define(function (require) {
  ...
  return function DocSourceFactory(Private, Promise, es, sessionStorage) {
    let sendToEs = Private(require('plugins/customTileMap/ui/courier/data_source/_doc_send_to_es'));
    let SourceAbstract = Private(require('plugins/customTileMap/ui/courier/data_source/_abstract'));
    let DocRequest = Private(require('plugins/customTileMap/ui/courier/fetch/request/doc'));
