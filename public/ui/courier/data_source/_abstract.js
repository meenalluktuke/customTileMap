define(function (require) {
  ...
  return function SourceAbstractFactory(Private, Promise, PromiseEmitter) {
    ...
    let courierFetch = Private(require('plugins/customTileMap/ui/courier/fetch/fetch'));
    ...
    SourceAbstract.prototype._flatten = function () {
      ...
      .then(function () {
        if (type === 'search') {
          ...
          let decorateQuery = Private(require('plugins/customTileMap/ui/courier/data_source/_decorate_query'));
