define(function (require) {
  return function SearchSourceFactory(Promise, Private) {
    ...
    let SourceAbstract = Private(require('plugins/customTileMap/ui/courier/data_source/_abstract'));
    let SearchRequest = Private(require('plugins/customTileMap/ui/courier/fetch/request/search'));
    let SegmentedRequest = Private(require('plugins/customTileMap/ui/courier/fetch/request/segmented'));
    let searchStrategy = Private(require('plugins/customTileMap/ui/courier/fetch/strategy/search'));
    let normalizeSortRequest = Private(require('plugins/customTileMap/ui/courier/data_source/_normalize_sort_request'));
    let rootSearchSource = require('plugins/customTileMap/ui/courier/data_source/_root_search_source');
