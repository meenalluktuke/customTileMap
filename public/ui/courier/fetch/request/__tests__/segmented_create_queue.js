describe('plugins/customTileMap/ui/courier/fetch/request/segmented/_createQueue', () => {
  ...
  beforeEach(ngMock.inject((Private, $injector) => {
    ...
    SegmentedReq = Private(require('plugins/customTileMap/ui/courier/fetch/request/segmented'));
