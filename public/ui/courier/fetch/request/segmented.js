define(function (require) {
  return function CourierSegmentedReqProvider(es, Private, Promise, Notifier, timefilter, config) {
    ...
    let SearchReq = Private(require('plugins/customTileMap/ui/courier/fetch/request/search'));
    let SegmentedHandle = Private(require('plugins/customTileMap/ui/courier/fetch/request/_segmented_handle'));
