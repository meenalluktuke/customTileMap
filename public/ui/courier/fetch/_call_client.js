define(function (require) {
  return function CourierFetchCallClient(Private, Promise, es, esShardTimeout, sessionId) {
    ...
    let isRequest = Private(require('plugins/customTileMap/ui/courier/fetch/_is_request'));
    let mergeDuplicateRequests = Private(require('plugins/customTileMap/ui/courier/fetch/_merge_duplicate_requests'));
