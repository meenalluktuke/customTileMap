...
import FetchProvider from 'plugins/customTileMap/ui/courier/fetch';
...
describe('Fetch service', function () {
  ...
  beforeEach(ngMock.inject(function ($injector, Private) {
    ...
    SearchSource = Private(require('plugins/customTileMap/ui/courier/data_source/search_source'));
  }));
