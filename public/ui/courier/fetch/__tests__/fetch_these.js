describe('plugins/customTileMap/ui/courier/fetch/_fetch_these', () => {
  ...
  beforeEach(ngMock.module('kibana', (PrivateProvider) => {
    ...
    PrivateProvider.swap(require('plugins/customTileMap/ui/courier/fetch/_call_client'), FakeResponsesProvider);
    PrivateProvider.swap(require('plugins/customTileMap/ui/courier/fetch/_call_response_handlers'), FakeResponsesProvider);
    PrivateProvider.swap(require('plugins/customTileMap/ui/courier/fetch/_continue_incomplete'), FakeResponsesProvider);
  }));

  beforeEach(ngMock.inject((Private, $injector) => {
    $rootScope = $injector.get('$rootScope');
    Promise = $injector.get('Promise');
    fetchThese = Private(require('plugins/customTileMap/ui/courier/fetch/_fetch_these'));
    request = mockRequest();
    requests = [ request ];
  }));
