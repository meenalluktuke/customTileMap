define(function (require) {
  ...
  let parseRange = require('plugins/customTileMap/ui/utils/range');

  require('plugins/customTileMap/ui/number_list/number_list_input');
  require('plugins/customTileMap/ui/modules')
  .get('kibana')
  .directive('kbnNumberList', function () {
    return {
      restrict: 'E',
      template: require('plugins/customTileMap/ui/number_list/number_list.html'),
