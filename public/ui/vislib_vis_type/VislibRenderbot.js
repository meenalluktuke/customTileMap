module.exports = function VislibRenderbotFactory(Private) {
  ...
  let vislib = Private(require('plugins/customTileMap/ui/vislib'));
  let Renderbot = Private(require('plugins/customTileMap/ui/Vis/Renderbot'));
  let buildChartData = Private(require('plugins/customTileMap/ui/vislib_vis_type/buildChartData'));
