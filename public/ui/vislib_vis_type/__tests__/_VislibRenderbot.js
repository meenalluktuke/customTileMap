describe('renderbot', function exportWrapper() {
  ...
  function init() {
    ...
    ngMock.inject(function ($injector, Private) {
      vislib = Private(require('plugins/customTileMap/ui/vislib'));
      Vis = Private(require('plugins/customTileMap/ui/vislib/vis'));
      Renderbot = Private(require('plugins/customTileMap/ui/Vis/Renderbot'));
      VislibRenderbot = Private(require('plugins/customTileMap/ui/vislib_vis_type/VislibRenderbot'));
      persistedState = new (Private(require('plugins/customTileMap/ui/persisted_state/persisted_state')))();
      normalizeChartData = Private(require('plugins/customTileMap/ui/agg_response/index'));
    });
  }
