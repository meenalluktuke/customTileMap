define(function (require) {
  ...
  .directive('visualize', function (Notifier, SavedVis, indexPatterns, Private, config, $timeout) {
    ...
    require('plugins/customTileMap/ui/visualize/spy');
    require('plugins/customTileMap/ui/visualize/visualize.less');
    require('plugins/customTileMap/ui/visualize/visualize_legend');

    let $ = require('jquery');
    let _ = require('lodash');
    let visTypes = Private(require('plugins/customTileMap/ui/registry/vis_types'));
    ...
    return {
      ...
      template: require('plugins/customTileMap/ui/visualize/visualize.html'),
