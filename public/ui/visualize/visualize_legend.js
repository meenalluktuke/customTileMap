define(function (require) {
  ...
  let html = require('plugins/customTileMap/ui/visualize/visualize_legend.html');

  let $ = require('jquery');
  let d3 = require('d3');
  let findByParam = require('plugins/customTileMap/ui/utils/find_by_param');
  ...
  .directive('visualizeLegend', function (Private, getAppState) {
    ...
    let colorPalette = Private(require('plugins/customTileMap/ui/vislib/components/color/color'));
    let filterBarClickHandler = Private(require('plugins/customTileMap/ui/filter_bar/filter_bar_click_handler'));
