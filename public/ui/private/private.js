define(function (require) {
   ...
   *     let ping = Private(require('plugins/customTileMap/ui/ping'));
   *     return {
   ...
   *     require('plugins/customTileMap/ui/agg_response/hierarchical/_build_split'),
   ...
   *     require('plugins/customTileMap/ui/courier/_redirect_when_missing'),
