define(function (require) {
  let html = require('plugins/customTileMap/ui/timepicker/timepicker.html');
  let module = require('plugins/customTileMap/ui/modules').get('plugins/customTileMap/ui/timepicker');
  let _ = require('lodash');
  let dateMath = require('plugins/customTileMap/ui/utils/dateMath');
  let moment = require('moment');

  require('plugins/customTileMap/ui/directives/input_datetime');
  require('plugins/customTileMap/ui/directives/inequality');
  require('plugins/customTileMap/ui/timepicker/quick_ranges');
  require('plugins/customTileMap/ui/timepicker/refresh_intervals');
  require('plugins/customTileMap/ui/timepicker/time_units');
  require('plugins/customTileMap/ui/timepicker/toggle');
