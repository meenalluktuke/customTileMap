define(function (require) {
  return function buildHierarchicalDataProvider(Private, Notifier) {
    ...
    let buildSplit = Private(require('plugins/customTileMap/ui/agg_response/hierarchical/_build_split'));
    let extractBuckets = require('plugins/customTileMap/ui/agg_response/hierarchical/_extract_buckets');
    let createRawData = require('plugins/customTileMap/ui/agg_response/hierarchical/_create_raw_data');
    let arrayToLinkedList = require('plugins/customTileMap/ui/agg_response/hierarchical/_array_to_linked_list');
    let tooltipFormatter = Private(require('plugins/customTileMap/ui/agg_response/hierarchical/_hierarchical_tooltip_formatter'));
