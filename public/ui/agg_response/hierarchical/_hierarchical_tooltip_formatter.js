define(function (require) {
  return function HierarchicalTooltipFormaterProvider($rootScope, $compile, $sce) {
    ...
    let $ = require('jquery');
    let $tooltip = $(require('plugins/customTileMap/ui/agg_response/hierarchical/_tooltip.html'));
    let collectBranch = require('plugins/customTileMap/ui/agg_response/hierarchical/_collect_branch');
