define(function (require) {
  return function biuldSplitProvider(Private) {
    let transformer = Private(require('plugins/customTileMap/ui/agg_response/hierarchical/_transform_aggregation'));
    let collectKeys = require('plugins/customTileMap/ui/agg_response/hierarchical/_collect_keys');
