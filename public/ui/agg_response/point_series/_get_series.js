define(function (require) {
  return function PointSeriesGetSeries(Private) {
    ...
    let getPoint = Private(require('plugins/customTileMap/ui/agg_response/point_series/_get_point'));
    let addToSiri = Private(require('plugins/customTileMap/ui/agg_response/point_series/_add_to_siri'));
