describe('getAspects', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    ...
    Table = Private(require('plugins/customTileMap/ui/agg_response/point_series/_add_to_siri'));
    AggConfig = Private(require('plugins/customTileMap/ui/Vis/AggConfig'));
    getAspects = Private(require('plugins/customTileMap/ui/agg_response/point_series/_get_aspects'));
