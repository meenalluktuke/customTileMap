define(function (require) {
  return function TabbedAggResponseWriterProvider(Private) {
    ...
    let Table = Private(require('plugins/customTileMap/ui/agg_response/tabify/_table'));
    let TableGroup = Private(require('plugins/customTileMap/ui/agg_response/tabify/_table_group'));
    let getColumns = Private(require('plugins/customTileMap/ui/agg_response/tabify/_get_columns'));
