  ...
  function defineSetup(stubGetColumns) {
    ...
    beforeEach(ngMock.inject(function ($injector) {
      ...
      if (stubGetColumns) {
        ...
        Private.stub(require('plugins/customTileMap/ui/agg_response/tabify/_get_columns'), getColumns);
      }

      ResponseWriter = Private(require('plugins/customTileMap/ui/agg_response/tabify/_response_writer'));
      TableGroup = Private(require('plugins/customTileMap/ui/agg_response/tabify/_table_group'));
      Buckets = Private(require('plugins/customTileMap/ui/agg_response/tabify/_buckets'));
