define(function (require) {
  return function tabifyAggResponseProvider(Private, Notifier) {
    ...
    let TabbedAggResponseWriter = Private(require('plugins/customTileMap/ui/agg_response/tabify/_response_writer'));
    let Buckets = Private(require('plugins/customTileMap/ui/agg_response/tabify/_buckets'));
