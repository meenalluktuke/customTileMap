define(function (require) {
  ...
  return function (Private, $rootScope, getAppState, globalState) {
    let EventEmitter = Private(require('plugins/customTileMap/ui/events'));
    let onlyDisabled = require('plugins/customTileMap/ui/filter_bar/lib/onlyDisabled');
    let onlyStateChanged = require('plugins/customTileMap/ui/filter_bar/lib/onlyStateChanged');
    let uniqFilters = require('plugins/customTileMap/ui/filter_bar/lib/uniqFilters');
    let compareFilters = require('plugins/customTileMap/ui/filter_bar/lib/compareFilters');
