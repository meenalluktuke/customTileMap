define(function (require) {
  ...
  let template = require('plugins/customTileMap/ui/filter_bar/filter_bar.html');
  let moment = require('moment');
  let angular = require('angular');

  require('plugins/customTileMap/ui/directives/json_input');

  module.directive('filterBar', function (Private, Promise, getAppState) {
    let mapAndFlattenFilters = Private(require('plugins/customTileMap/ui/filter_bar/lib/mapAndFlattenFilters'));
    let mapFlattenAndWrapFilters = Private(require('plugins/customTileMap/ui/filter_bar/lib/mapFlattenAndWrapFilters'));
    let extractTimeFilter = Private(require('plugins/customTileMap/ui/filter_bar/lib/extractTimeFilter'));
    let filterOutTimeBasedFilter = Private(require('plugins/customTileMap/ui/filter_bar/lib/filterOutTimeBasedFilter'));
    let filterAppliedAndUnwrap = require('plugins/customTileMap/ui/filter_bar/lib/filterAppliedAndUnwrap');
    let changeTimeFilter = Private(require('plugins/customTileMap/ui/filter_bar/lib/changeTimeFilter'));
    let queryFilter = Private(require('plugins/customTileMap/ui/filter_bar/query_filter'));
