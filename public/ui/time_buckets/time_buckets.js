define(function (require) {
  return function IntervalHelperProvider(Private, timefilter, config) {
    ...
    let parseInterval = require('plugins/customTileMap/ui/utils/parse_interval');
    let calcAuto = Private(require('plugins/customTileMap/ui/time_buckets/calc_auto_interval'));
    let calcEsInterval = Private(require('plugins/customTileMap/ui/time_buckets/calc_es_interval'));
