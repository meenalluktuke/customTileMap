describe('plugins/customTileMap/ui/index_patterns/_calculate_indices', () => {
  ...
  beforeEach(ngMock.inject((Private, $injector) => {
    ...
    calculateIndices = Private(require('plugins/customTileMap/ui/index_patterns/_calculate_indices'));
  }));
