define(function (require) {
  return function MapperService(Private, Promise, es, config, kbnIndex) {
    ...
    let IndexPatternMissingIndices = require('plugins/customTileMap/ui/errors').IndexPatternMissingIndices;
    let transformMappingIntoFields = Private(require('plugins/customTileMap/ui/index_patterns/_transform_mapping_into_fields'));
    let intervals = Private(require('plugins/customTileMap/ui/index_patterns/_intervals'));
    let patternToWildcard = Private(require('plugins/customTileMap/ui/index_patterns/_pattern_to_wildcard'));

    let LocalCache = Private(require('plugins/customTileMap/ui/index_patterns/_local_cache'));
