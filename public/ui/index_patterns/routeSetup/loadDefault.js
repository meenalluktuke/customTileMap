...
let { NoDefaultIndexPattern, NoDefinedIndexPatterns } = require('plugins/customTileMap/ui/errors');
let Notifier = require('plugins/customTileMap/ui/notify/notifier');
...
module.exports = function (opts) {
  ...
  .addSetupWork(function loadDefaultIndexPattern(Private, Promise, $route, config, indexPatterns) {
    ...
    let rootSearchSource = Private(require('plugins/customTileMap/ui/courier/data_source/_root_search_source'));
