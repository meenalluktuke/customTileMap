define(function (require) {
  ...
  require('plugins/customTileMap/ui/filters/uriescape');
  require('plugins/customTileMap/ui/filters/rison');

  require('plugins/customTileMap/ui/modules').get('kibana/url')
