define(function (require) {
  ...
  let $ = require('jquery');
  let addWordBreaks = require('plugins/customTileMap/ui/utils/add_word_breaks');
  let module = require('plugins/customTileMap/ui/modules').get('app/discover');

  require('plugins/customTileMap/ui/highlight');
  require('plugins/customTileMap/ui/highlight/highlight_tags');
  require('plugins/customTileMap/ui/doc_viewer');
  require('plugins/customTileMap/ui/filters/trust_as_html');
  ...
  module.directive('kbnTableRow', function ($compile) {
    ...
    let openRowHtml = require('plugins/customTileMap/ui/doc_table/components/table_row/open.html');
    let detailsHtml = require('plugins/customTileMap/ui/doc_table/components/table_row/details.html');
    let cellTemplate = _.template(noWhiteSpace(require('plugins/customTileMap/ui/doc_table/components/table_row/cell.html')));
    let truncateByHeightTemplate = _.template(noWhiteSpace(require('plugins/customTileMap/ui/partials/truncate_by_height.html')));
