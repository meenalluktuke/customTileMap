define(function (require) {
  ...
  let html = require('plugins/customTileMap/ui/doc_table/doc_table.html');
  let getSort = require('plugins/customTileMap/ui/doc_table/lib/get_sort');

  require('plugins/customTileMap/ui/doc_table/doc_table.less');
  require('plugins/customTileMap/ui/directives/truncated');
  require('plugins/customTileMap/ui/directives/infinite_scroll');
  require('plugins/customTileMap/ui/doc_table/components/table_header');
  require('plugins/customTileMap/ui/doc_table/components/table_row');

  require('plugins/customTileMap/ui/modules').get('kibana')
