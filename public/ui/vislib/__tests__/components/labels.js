...
describe('Vislib Labels Module Test Suite', function () {
  ...
  describe('Labels (main)', function () {
    ...
    beforeEach(ngMock.inject(function (Private) {
      getLabels = Private(require('plugins/customTileMap/ui/vislib/components/labels/labels'));
  ...
  describe('Data array', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      dataArray = Private(require('plugins/customTileMap/ui/vislib/components/labels/data_array'));
  ...
  describe('Unique labels', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      uniqLabels = Private(require('plugins/customTileMap/ui/vislib/components/labels/uniq_labels'));
  ...
  describe('Get series', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      getSeries = Private(require('plugins/customTileMap/ui/vislib/components/labels/flatten_series'));
