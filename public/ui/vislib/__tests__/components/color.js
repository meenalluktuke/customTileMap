...
describe('Vislib Color Module Test Suite', function () {
  ...
  describe('Color (main)', function () {
    ...
    beforeEach(ngMock.inject((Private, config) => {
      ...
      seedColors = Private(require('plugins/customTileMap/ui/vislib/components/color/seed_colors'));
      getColors = Private(require('plugins/customTileMap/ui/vislib/components/color/color'));
      mappedColors = Private(require('plugins/customTileMap/ui/vislib/components/color/mapped_colors'));
      color = getColors(arr, {});
    }));
  ...
  describe('Color Palette', function () {
    ...
    beforeEach(ngMock.inject(function (Private) {
      seedColors = Private(require('plugins/customTileMap/ui/vislib/components/color/seed_colors'));
      createColorPalette = Private(require('plugins/customTileMap/ui/vislib/components/color/color_palette'));
