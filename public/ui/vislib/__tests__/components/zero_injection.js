...
describe('Vislib Zero Injection Module Test Suite', function () {
  ...
  describe('Zero Injection (main)', function () {
    ...
    beforeEach(ngMock.inject(function (Private) {
      injectZeros = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/inject_zeros'));
  ...
  describe('Order X Values', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      orderXValues = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/ordered_x_keys'));
  ...
  describe('Unique Keys', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      uniqueKeys = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/uniq_keys'));
  ...
  describe('Flatten Data', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      flattenData = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/flatten_data'));
  ...
  describe('Zero Filled Array', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      createZeroArray = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/zero_filled_array'));
  ...
  describe('Zero Filled Data Array', function () {
    ...
    beforeEach(ngMock.module('kibana'));
    beforeEach(ngMock.inject(function (Private) {
      zeroFillArray = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/zero_fill_data_array'));
      createZeroArray = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/zero_filled_array'));
