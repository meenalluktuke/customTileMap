...
describe('Vislib Resize Checker', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    ResizeChecker = Private(require('plugins/customTileMap/ui/vislib/lib/resize_checker'));
    EventEmitter = Private(require('plugins/customTileMap/ui/events'));
    reflowWatcher = Private(require('plugins/customTileMap/ui/reflow_watcher'));
