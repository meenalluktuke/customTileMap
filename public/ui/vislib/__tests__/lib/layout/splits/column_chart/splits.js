...
describe('Vislib Split Function Test Suite', function () {
  describe('Column Chart', function () {
    ...
    beforeEach(ngMock.inject(function (Private) {
      chartSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/chart_split'));
      chartTitleSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/chart_title_split'));
      xAxisSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/x_axis_split'));
      yAxisSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/y_axis_split'));
