...
describe('Vislib AxisTitle Class Test Suite', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    AxisTitle = Private(require('plugins/customTileMap/ui/vislib/lib/axis_title'));
    Data = Private(require('plugins/customTileMap/ui/vislib/lib/data'));
    PersistedState = Private(require('plugins/customTileMap/ui/persisted_state/persisted_state'));
