...
describe('Vislib _chart Test Suite', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    ...
    ColumnChart = Private(require('plugins/customTileMap/ui/vislib/visualizations/column_chart'));
    Chart = Private(require('plugins/customTileMap/ui/vislib/visualizations/_chart'));
