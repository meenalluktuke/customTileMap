...
describe('TileMap Tests', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    Private.stub(require('plugins/customTileMap/ui/vislib/visualizations/_map'), MockMap);
    TileMap = Private(require('plugins/customTileMap/ui/vislib/visualizations/custom_tile_map'));
