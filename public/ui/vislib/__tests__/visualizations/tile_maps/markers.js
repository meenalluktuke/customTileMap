...
describe('Marker Tests', function () {
  ...
  describe('Base Methods', function () {
    ...
    beforeEach(ngMock.inject(function (Private) {
      MarkerClass = Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/base_marker'));
  ...
  describe('Shaded Circles', function () {
    beforeEach(ngMock.module('MarkerFactory'));
    beforeEach(ngMock.inject(function (Private) {
      let MarkerClass = Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/shaded_circles'));
      markerLayer = createMarker(MarkerClass);
    }));
  ...
  describe('Scaled Circles', function () {
    ...
    beforeEach(ngMock.inject(function (Private) {
      ...
      let MarkerClass = Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/scaled_circles'));
      markerLayer = createMarker(MarkerClass);
    }));
  ...
  describe('Heatmaps', function () {
    beforeEach(ngMock.module('MarkerFactory'));
    beforeEach(ngMock.inject(function (Private) {
      let MarkerClass = Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/heatmap'));
      markerLayer = createMarker(MarkerClass);
    }));
