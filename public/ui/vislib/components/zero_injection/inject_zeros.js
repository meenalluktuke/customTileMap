define(function (require) {
  return function ZeroInjectionUtilService(Private) {
    ...
    let orderXValues = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/ordered_x_keys'));
    let createZeroFilledArray = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/zero_filled_array'));
    let zeroFillDataArray = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/zero_fill_data_array'));
