define(function (require) {
  return function LabelUtilService(Private) {
    ...
    let createArr = Private(require('plugins/customTileMap/ui/vislib/components/labels/data_array'));
    let getArrOfUniqLabels = Private(require('plugins/customTileMap/ui/vislib/components/labels/uniq_labels'));
    let getPieLabels = Private(require('plugins/customTileMap/ui/vislib/components/labels/pie/pie_labels'));
