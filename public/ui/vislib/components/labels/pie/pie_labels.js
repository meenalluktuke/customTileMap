define(function (require) {
  ...
  return function PieLabels(Private) {
    let removeZeroSlices = Private(require('plugins/customTileMap/ui/vislib/components/labels/pie/remove_zero_slices'));
    let getNames = Private(require('plugins/customTileMap/ui/vislib/components/labels/pie/get_pie_names'));
