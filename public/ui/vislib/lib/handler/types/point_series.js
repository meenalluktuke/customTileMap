define(function (require) {
  return function ColumnHandler(Private) {
    let injectZeros = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/inject_zeros'));
    ...
    let XAxis = Private(require('plugins/customTileMap/ui/vislib/lib/x_axis'));
    let YAxis = Private(require('plugins/customTileMap/ui/vislib/lib/y_axis'));
    let AxisTitle = Private(require('plugins/customTileMap/ui/vislib/lib/axis_title'));
    let ChartTitle = Private(require('plugins/customTileMap/ui/vislib/lib/chart_title'));
    let Alerts = Private(require('plugins/customTileMap/ui/vislib/lib/alerts'));
