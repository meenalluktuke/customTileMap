define(function (require) {
  return function ColumnLayoutFactory(Private) {
    let d3 = require('d3');
    let chartSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/pie_chart/chart_split'));
    let chartTitleSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/pie_chart/chart_title_split'));
