define(function (require) {
  return function ColumnLayoutFactory(Private) {
    ...
    let chartSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/chart_split'));
    let yAxisSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/y_axis_split'));
    let xAxisSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/x_axis_split'));
    let chartTitleSplit = Private(require('plugins/customTileMap/ui/vislib/lib/layout/splits/column_chart/chart_title_split'));
