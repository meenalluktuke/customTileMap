define(function (require) {
  return function DataFactory(Private) {
    ...
    let orderKeys = Private(require('plugins/customTileMap/ui/vislib/components/zero_injection/ordered_x_keys'));
    let getLabels = Private(require('plugins/customTileMap/ui/vislib/components/labels/labels'));
    let color = Private(require('plugins/customTileMap/ui/vislib/components/color/color'));
