define(function (require) {
  return function ChartBaseClass(Private) {
    ...
    let Dispatch = Private(require('plugins/customTileMap/ui/vislib/lib/dispatch'));
    let Tooltip = Private(require('plugins/customTileMap/ui/vislib/components/Tooltip'));
    let dataLabel = require('plugins/customTileMap/ui/vislib/lib/_data_label');
