define(function (require) {
  return function MapFactory(Private) {
    ...
    let markerTypes = {
      'Scaled Circle Markers': Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/scaled_circles')),
      'Shaded Circle Markers': Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/shaded_circles')),
      'Shaded Geohash Grid': Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/geohash_grid')),
      'Heatmap': Private(require('plugins/customTileMap/ui/vislib/visualizations/marker_types/heatmap')),
    };
    ...
    TileMapMap.prototype._addMarkers = function () {
      ...
      if (this._geoJson.features.length > 1) {
		  ...
		  var value="";
		  var objcount=0;
		values = this._geoJson.features.map(function (feature) {
        value=feature.properties.typehash;
		//console.log("In _map.js, value is:"+value);
		...
		if(value!==undefined){
			...
			objcount=0;
			console.log("In _map.js, undefined value is:"+value);
		}
        ...
        if(objcount>0){
			...
			console.log("objcount in _map.js"+objcount);
		}
      
    }
	else{
		console.log("features array length is < 1");
	}
	};
