define(function (require) {
  return function ColumnChartFactory(Private) {
    ...
    let DataClass = Private(require('plugins/customTileMap/ui/vislib/lib/data'));

    let PointSeriesChart = Private(require('plugins/customTileMap/ui/vislib/visualizations/_point_series_chart'));
    let TimeMarker = Private(require('plugins/customTileMap/ui/vislib/visualizations/time_marker'));
