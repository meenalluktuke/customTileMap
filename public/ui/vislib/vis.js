define(function (require) {
  return function VisFactory(Private) {
    ...
    let Binder = require('plugins/customTileMap/ui/Binder');

    let ResizeChecker = Private(require('plugins/customTileMap/ui/vislib/lib/resize_checker'));
    let Events = Private(require('plugins/customTileMap/ui/events'));
    let handlerTypes = Private(require('plugins/customTileMap/ui/vislib/lib/handler/handler_types'));
    let chartTypes = Private(require('plugins/customTileMap/ui/vislib/visualizations/vis_types'));
