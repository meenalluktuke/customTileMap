define(function (require) {
  ...
  let keymap = require('plugins/customTileMap/ui/utils/key_map');

  module.directive('savedObjectFinder', function ($location, $injector, kbnUrl, Private, config) {

    let services = Private(require('plugins/customTileMap/ui/saved_objects/saved_object_registry')).byLoaderPropertiesName;
    ...
    return {
      ...
      template: require('plugins/customTileMap/ui/partials/saved_object_finder.html'),
      controllerAs: 'finder',
