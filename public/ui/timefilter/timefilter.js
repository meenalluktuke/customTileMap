define(function (require) {
  require('plugins/customTileMap/ui/routes')
  ...
  .service('timefilter', function (Private, globalState, $rootScope, config) {
    ...
    let Events = Private(require('plugins/customTileMap/ui/events'));
    let diff = Private(require('plugins/customTileMap/ui/utils/diff_time_picker_vals'));

    require('plugins/customTileMap/ui/state_management/global_state');
    ...
    function Timefilter() {
      ...
      let self = this;
      let diffTime = Private(require('plugins/customTileMap/ui/timefilter/lib/diff_time'))(self);
      let diffInterval = Private(require('plugins/customTileMap/ui/timefilter/lib/diff_interval'))(self);
