...
import ConfigTemplate from 'plugins/customTileMap/ui/ConfigTemplate';
...
export default function (chrome, internals) {
  ...
  .directive('kbnChrome', function ($rootScope) {
    return {
      template($el) {
        const $content = $(require('plugins/customTileMap/ui/chrome/chrome.html'));
      ...
      controller($scope, $rootScope, $location, $http) {
        ...
        $scope.notifList = require('plugins/customTileMap/ui/notify')._notifs;
