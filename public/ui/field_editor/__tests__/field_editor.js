describe('FieldEditor directive', function () {
  ...
  beforeEach(ngMock.inject(function ($compile, $injector, Private) {
    ...
    Field = Private(require('plugins/customTileMap/ui/index_patterns/_field'));
    StringFormat = Private(require('plugins/customTileMap/ui/registry/field_formats')).getType('string');
