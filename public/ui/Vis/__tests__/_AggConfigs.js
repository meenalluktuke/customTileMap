describe('AggConfigs', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    ...
    let RealAggConfigPM = require('plugins/customTileMap/ui/Vis/AggConfig');
    ...
    SpiedAggConfig = Private(require('plugins/customTileMap/ui/Vis/AggConfig'));
    AggConfigs = Private(require('plugins/customTileMap/ui/Vis/AggConfigs'));
    IndexedArray = require('plugins/customTileMap/ui/IndexedArray');
    indexPattern = Private(require('fixtures/stubbed_logstash_index_pattern'));
    Schemas = Private(require('plugins/customTileMap/ui/Vis/Schemas'));
  }));
