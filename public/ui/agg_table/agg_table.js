define(function (require) {
  require('plugins/customTileMap/ui/paginated_table');
  require('plugins/customTileMap/ui/compile_recursive_directive');
  require('plugins/customTileMap/ui/agg_table/agg_table.less');
  ...
  .directive('kbnAggTable', function ($filter, config, Private, compileRecursiveDirective) {
    ...
    return {
      restrict: 'E',
      template: require('plugins/customTileMap/ui/agg_table/agg_table.html'),
      scope: {
        table: '=',
        perPage: '=?',
        exportTitle: '=?'
