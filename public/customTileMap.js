define(function (require) {
  function customTileMapVisType(Private, getAppState, courier,config) {
    ...
    return new VislibVisType({
      ...
      title: 'My Tile map',
      icon: 'fa-map-signs',
      description: 'Your source for custom geographic maps. Requires an elasticsearch geo_point field and one optional string field to divide the colors.',
      params: {
        defaults: {
      ...
      listeners: {
        ...
        mapZoomEnd: function (event) {
          ...
          const precision = config.get('visualization:customTileMap:maxPrecision');
